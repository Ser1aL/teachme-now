class Lesson < ActiveRecord::Base
  attr_accessible :capacity, :city, :course_id, :description, :duration, :interest_id, :level, :name, :owner_id, :place_price, :places_taken, :start_date, :start_time, :sub_interest_id, :tease_description
  belongs_to :interest
