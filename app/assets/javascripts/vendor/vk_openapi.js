...
if (!VK.xdConnectionCallbacks) {
    ...
    if (!VK.Auth) {
        VK.Auth = {
            ...
            login: function(cb, settings, redirect_url) {
                var channel, url;
                if(!VK._apiId) {
                    return false;
                }
                channel = window.location.protocol + '//' + window.location.hostname;
                redirect_url = window.location.protocol + '//' + window.location.hostname + redirect_url;
                url = VK._domain.main + VK._path.login + '?client_id='+VK._apiId+'&display=popup&redirect_uri='+redirect_url+'&response_type=code&scope=notify,offline';
